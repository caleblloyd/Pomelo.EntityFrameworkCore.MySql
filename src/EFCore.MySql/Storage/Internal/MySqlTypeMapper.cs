...
namespace EFCore.MySql.Storage.Internal
{
    public class MySqlTypeMapper : RelationalTypeMapper
    {
            ...
            : base(dependencies)
        {
            ...
            _clrTypeMappings
                = new Dictionary<Type, RelationalTypeMapping>
                {
	                ...
	                { typeof(DateTimeOffset), _timeStamp6 },
        ...
        public override RelationalTypeMapping FindMapping(Type clrType)
        {
            ...
            var mapping = clrType == typeof(string)
                ? _varcharmax
                : (clrType == typeof(byte[])
                    ? _varbinarymax
                    : base.FindMapping(clrType));

            Console.WriteLine($"MySqlTypeMapper: FindMapping(Type clrType); clrType = {clrType}; mapping = {mapping}");
            return mapping;
        }
        ...
        public override RelationalTypeMapping FindMapping(IProperty property)
        {
            ...
            Console.WriteLine($"MySqlTypeMapper: FindMapping(IProperty property); property.Name = {property.Name}; mapping = {mapping}");
            return mapping;
        }
        ...
        public override RelationalTypeMapping FindMapping(string storeType)
        {
            ...
            Console.WriteLine($"MySqlTypeMapper: FindMapping(string storeType); storeType = {storeType}; mapping = {mapping}");
            return mapping;
        }
